...
//creamos un forEach para q recorra todos los elementos
...
function createInsect() {
    ...
    insect.innerHTML = `<img src ="${selected_insect.src}" alt= "${selected_insect.alt}" style="transform: 
